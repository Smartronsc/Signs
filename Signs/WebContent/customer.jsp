...
<div id="logo">
	...
	<h2> &raquo;&nbsp;&nbsp;&nbsp;All your signage needs</h2>
</div>
<div id="header">
	<div id="menu">
		<ul>
            ...
            <li><a href="basic_vehicle/vehicle_signs.html">Vehicle Signs</a></li>
			<li><a href="basic_monument/monument_signs.html">Monument/Freestanding</a></li>
			<li><a href="basic_wall_signs/wall_signs.html">Wall</a></li>
            <li><a href="basic_window_signs/window_signs.html">Interior/Glass</a></li>
            <li><a href="basic_sandblasted_signs/sandblasted_signs.html">Sandblasted</a></li>
...
<div id="page">
  ...
  <tr>
    <td>Santa Cruz &amp; Aptos Coffee Roasting<br />
      <a href="maplocations" onclick="location.href=this.href+'?key=company0001';return false;">Knox Roofing</a><br /> 
      Knox Box<br />
      <a href="maplocations" onclick="location.href=this.href+'?key=company0002';return false;">Santa Cruz Memorial Park</a><br />
      <a href="maplocations" onclick="location.href=this.href+'?key=company0030';return false;">Oakwood Memorial Park</a><br />
      <a href="maplocations" onclick="location.href=this.href+'?key=company0029';return false;">Big Creek Lumber</a><br />
...
Plumbed Elegance
     ...
     Emily's<br />
        Hog's Seafood<br />
        Kianti's<br />
        Santa Cruz Fire Dept.<br />
        Conner Plumbing<br />
        Cafe Lucio<br />
        Roadhouse Davenport<br />
        King's Paint<br />
        Bay Photo<br />
        Old School Shoes<br />
        Gilbert's<br />
        ...
        Zinnia's<br />
        <a href="maplocations" onclick="location.href=this.href+'?key=company0004';return false;">Staff of Life</a><br />
        Pacific Gardens Chapel</p></td>
    <td>&nbsp;</td>
    <td><img src="images/customers_coffee.jpg" width="400" height="300" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<h2>Full Service</h2>
			<ul>
				...
				<li><a href="services.html">Fabricate</a></li>
				<li><a href="services.html">Install</a></li>
			...
			<li>
				<h2>Customers</h2>
				<ul>
					<li><a href="customer">Link to Customers</a></li>
					<li></li>
					<li></li>
				</ul>
			</li>
...
<!-- start footer -->
<div id="footer">
	<p id="legal">&#169; 2010 Donovan Signs. All Rights Reserved. </p>
</div>
<!-- end footer -->
</body>
</html>
